...
public class DeleteResourceTest extends AbstractRestTest {
  ...
  private Object getParamsDeleteResource() {
    return new Object[]{
        // Element
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.NULL_AUTH,
        ...
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.GIBBERISH_FULL,
            IdMatchingSelector.NULL_ID, HttpConstants.METHOD_NOT_ALLOWED, HttpConstants.OK},
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.GIBBERISH_FULL,
            IdMatchingSelector.GIBBERISH, HttpConstants.FORBIDDEN, HttpConstants.OK},
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.GIBBERISH_FULL,
        ...
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.GIBBERISH_KEY,
            IdMatchingSelector.NULL_ID, HttpConstants.METHOD_NOT_ALLOWED, HttpConstants.OK},
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.GIBBERISH_KEY,
            IdMatchingSelector.GIBBERISH, HttpConstants.FORBIDDEN, HttpConstants.OK},
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.GIBBERISH_KEY,
        ...
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.TEST_USER_1,
            IdMatchingSelector.NULL_ID, HttpConstants.METHOD_NOT_ALLOWED, HttpConstants.OK},
        new Object[]{MINIMAL_ELEMENT_WITH_ID, CedarNodeType.ELEMENT, AuthHeaderSelector.TEST_USER_1,

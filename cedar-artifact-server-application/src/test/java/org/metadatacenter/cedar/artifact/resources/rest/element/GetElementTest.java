...
public class GetElementTest extends AbstractRestTest {
  ...
  @ParameterizedTest
  @MethodSource("getParamsGetElement")
  public void getElementTest(TestParameterArrayGeneratorGenerator generator,
    ...
    Assertions.assertEquals(expectedResponseStatus, getResponseStatus);
    ...
    if (expectedResponseStatus == CedarResponseStatus.OK.getStatusCode()) {
      ...
      try {
        getElement = JsonMapper.STRICT_MAPPER.readTree(createdBody);
      } catch (JsonParseException e) {
        // do nothing, the json can be invalid intentionally
      }
  ...
  static Object[] getParamsGetElement() {

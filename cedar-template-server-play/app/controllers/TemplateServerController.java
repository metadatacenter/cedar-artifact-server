...
public class TemplateServerController extends AbstractTemplateServerController {
  ...
  public static Result createTemplate() {
    try {
      Authorization.mustHaveCapability(request(), CedarCapability.TEMPLATE_CREATE);
  ...
  public static Result findTemplate(String templateId) {
    try {
      Authorization.mustHaveCapability(request(), CedarCapability.TEMPLATE_READ);
  ...
  public static Result updateTemplate(String templateId) {
    try {
      Authorization.mustHaveCapability(request(), CedarCapability.TEMPLATE_UPDATE);
  ...
  public static Result deleteTemplate(String templateId) {
    try {
      Authorization.mustHaveCapability(request(), CedarCapability.TEMPLATE_DELETE);

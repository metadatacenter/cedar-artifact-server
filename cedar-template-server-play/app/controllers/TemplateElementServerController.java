...
public class TemplateElementServerController extends AbstractTemplateServerController {
  ...
  public static Result createTemplateElement() {
    try {
      Authorization.mustHaveCapability(request(), CedarCapability.TEMPLATE_ELEMENT_CREATE);
      ...
      String absoluteUrl = routes.TemplateElementServerController.findTemplateElement(id).absoluteURL
          (request());
  ...
  public static Result findAllTemplateElements(Integer limit, Integer offset, boolean summary, String fieldNames) {
    try {
      Authorization.mustHaveCapability(request(), CedarCapability.TEMPLATE_ELEMENT_READ);
  ...
  public static Result updateTemplateElement(String templateElementId) {
    try {
      Authorization.mustHaveCapability(request(), CedarCapability.TEMPLATE_ELEMENT_UPDATE);
  ...
  public static Result deleteTemplateElement(String templateElementId) {
    try {
      Authorization.mustHaveCapability(request(), CedarCapability.TEMPLATE_ELEMENT_DELETE);
